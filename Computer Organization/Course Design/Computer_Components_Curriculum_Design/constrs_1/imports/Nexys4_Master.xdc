...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk_brd }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports {go}]; #IO_L4N_T0_D05_14 Sch=btnu
