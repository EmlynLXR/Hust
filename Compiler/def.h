...
enum node_kind  { EXT_DEF_LIST,EXT_VAR_DEF,FUNC_DEF,FUNC_DEC,EXT_DEC_LIST,PARAM_LIST,PARAM_DEC,ForFirVar,ForSecVar,ForThiVar,  COMADD,COMSUB,COMMUL,COMDIV,COMMOD,PREADD,PRESUB,AFTADD,AFTSUB,           VAR_DEF,DEC_LIST,DEF_LIST,COMP_STM,STM_LIST,EXP_STMT,IF_THEN,IF_THEN_ELSE, FUNC_CALL,ARGS, FUNCTION,PARAM,ARG,CALL,LABEL,GOTO,JLT,JLE,JGT,JGE,EQ,NEQ,EJLT,EJLE,EJGT,EJGE,EEQ,ENEQ};
