...
void display(struct node *T,int indent)  {//对抽象语法树的先根遍历
  ...
  if (T)
    ...
    case FOR:         printf("%*c循环语句(FOR)：\n",indent,' ');
                          ...
                          break;
    case ForFirVar: 
                          printf("%*cFirst Expression：\n",indent,' ');
                          display(T->ptr[0],indent+3);      //依次显示全部参数类型和名称，
                          display(T->ptr[1],indent); 
                          break;
    case ForSecVar:
                          printf("%*cSecond Expression：\n",indent,' ');
                          display(T->ptr[0],indent+3);      //依次显示全部参数类型和名称，
                          display(T->ptr[1],indent); 
                          break;
    case ForThiVar:    
                          printf("%*cThird Expression：\n",indent,' ');
                          display(T->ptr[0],indent+3);      //依次显示全部参数类型和名称，
                          display(T->ptr[1],indent); 
                          break;
